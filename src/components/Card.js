...
//   const maskCardHolder = (cardHolder) => {
//     if (cardHolder === 'FULL NAME') {
//       return ;
//     }
  
//     let cardHolderArr = cardHolder.split('');
//     cardHolderArr.forEach((val, index) => {
//       if (index > 0) {
//         cardHolderArr[index] = '*';
//       }
//     });
  
//     return cardHolderArr.join('');
//   };
